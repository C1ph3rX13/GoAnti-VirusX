...
func ModifyIconColor(inputFile, outputFile string, maxColorChange, count int) error {
	...
	logger.Infof("Original PNG Hash: %s", originalHash)
	...
	for i := 0; i < count; i++ {
		...
		logger.Infof("Modified PNG Hash: %s", modifiedHash)
